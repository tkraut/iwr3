	...
	public Unit(Node unitNode) {
		for (Node child = unitNode.getFirstChild(); child != null; child = child
			...
			if (child.getNodeName().equals("id")) {
				...
				attack = Integer.parseInt(child.getFirstChild()
						.getTextContent());
			} else if (child.getNodeName().equals("def")) {
				defense = Integer.parseInt(child.getFirstChild()
						.getTextContent());
				...
				turnsPerAttack = Integer.parseInt(child.getFirstChild()
						.getTextContent());
			} else if (child.getNodeName().equals("turnsmove")) {
				turnsPerMove = Integer.parseInt(child.getFirstChild()
						.getTextContent());
			} else if (child.getNodeName().equals("lobonus")) {
				lookoutBonus = Integer.parseInt(child.getFirstChild()
						.getTextContent());
			}
		}
