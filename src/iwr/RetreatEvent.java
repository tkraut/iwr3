...
public class RetreatEvent extends Event {
	...
	public String toString() {
		return super.toString()
				+ Messages.getString("RetreatEvent.Player") + field.ownerAt(time) + Messages.getString("RetreatEvent.retreated") + count + Messages.getString("RetreatEvent.unitsOfType") + field.armyAt(time - 1).unit + Messages.getString("RetreatEvent.from") + field; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	}
